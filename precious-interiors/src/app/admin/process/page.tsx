      ...
      {steps.length === 0 ? (
        <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-12 text-center">
          <div className="mx-auto w-16 h-16 bg-neutral-100 rounded-full flex items-center justify-center mb-4">
            <span className="text-2xl text-neutral-400">1</span>
          </div>
          <h3 className="text-lg font-medium text-neutral-900 mb-2">No process steps yet</h3>
          <p className="text-neutral-500">Process steps will appear here once added to the database.</p>
        </div>
      ) : (
